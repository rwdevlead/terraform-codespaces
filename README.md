...
| **#** | **Lab Name**                          |                             **AWS**                              |                               **Azure**                                |                                **GitHub**                                 |
| :---: | :------------------------------- | :--------------------------------------------------------------: | :--------------------------------------------------------------------: | :-----------------------------------------------------------------------: |
|  16   | Replacing a Single Resource | [AWS](./labs/lab_16_replace_a_single_resource/AWS/aws.md) | [Azure](./labs/lab_16_replace_a_single_resource/AZURE/azure.md) | Coming Soon |
